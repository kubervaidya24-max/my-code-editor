      ...
      for (const part of pathParts) {
        if (part) {
          const nextFolder = currentFolder.items.find(
            (item: TemplateFile | TemplateFolder) => "folderName" in item && item.folderName === part
          ) as TemplateFolder;
  ...
  handleRenameFolder: async (folder, newFolderName, parentPath, saveTemplateData) => {
    ...
    try {
      ...
      const folderIndex = currentFolder.items.findIndex(
        (item: TemplateFile | TemplateFolder) => "folderName" in item && item.folderName === folder.folderName
      );
